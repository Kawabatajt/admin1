  ...
  return (
    <div className="card">
      <div>
        <div>
          <div className="names">
            <h1 className={syne.className}>{users[0].firstName}</h1>
            <h2 className={syne.className}>{users[0].lastName}</h2>
          </div>
      ...
      <div className="card-right">
        ...
        <h1 className={montserrat.className}>{users[0].companyName}</h1>
